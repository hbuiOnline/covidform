...
<div class="login-page">
  <div class="form">
    ...
    <form class="login-form" action="makepdf.php" method="POST">
      <h1 class"title">Enter Phone Number Below</h1>
      <input type="text" name="phonenum" required placeholder="Phone Number"/>
